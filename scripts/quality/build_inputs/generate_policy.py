...
STATIC_SOURCES = (
    ...
    "config/quality/test-class-decomposition.json",
    ...
    "scripts/quality/build_inputs/test_class_decomposition.py",
...
def evidence_entrypoints() -> list[dict[str, object]]:
    ...
    rows = [
        ...
        entrypoint("local-colima/third-release", "scripts/quality/build_inputs/local_colima_evidence.py", "nested", ["./gradlew", ":app:assembleProdRelease", "--no-build-cache", "--no-configuration-cache", "--rerun-tasks", "--project-cache-dir", "{thirdProjectCache}", "-Dorg.gradle.java.installations.auto-detect=false", "-Dorg.gradle.java.installations.auto-download=false", "-Dorg.gradle.java.installations.paths={compileHome},{runtimeHome}"], "command-fresh"),
        testkit_entrypoint("testkit/shared-normal", fixture, ["GradleRunner.withArguments", "{fixture-arguments}", "--max-workers=2"], "testkit-fresh"),
        testkit_entrypoint("testkit/shared-configuration-cache", fixture, ["GradleRunner.withArguments", "{fixture-arguments}", "--configuration-cache", "--configuration-cache-problems=fail", "--max-workers=2"], "testkit-fresh"),
        testkit_entrypoint("testkit/adversarial", adversarial, ["GradleRunner.withArguments", "help", "--max-workers=2"], "testkit-adversarial-fresh"),
    ]
...
def policy() -> dict[str, object]:
    ...
    return {
        ...
        "evidence": {
            ...
            "fieldAllowlist": ["android", "attempt", "evidenceFiles", "gradle", "jdks", "policySha256", "runner", "schemaVersion", "sourceCommit", "wrapper"],
