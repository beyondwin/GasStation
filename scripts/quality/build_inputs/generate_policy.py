...
from scripts.quality.build_inputs.local_colima_evidence import (  # noqa: E402
    ...
    MAIN_BASE_COMMIT,
    MAIN_BASE_REF,
    METHOD_LEDGER_SHA256,
    OWNED_LABEL_KEYS,
    OUTER_TIMEOUT_MARKER_ENV,
    OUTER_TIMEOUT_MARKER_PATH,
    OUTER_TIMEOUT_PROPERTY,
    OWNER_LEDGER_SHA256,
    PROFILE,
...
def policy() -> dict[str, object]:
    ...
    return {
        ...
        "localEvidenceHost": {
            ...
            "outerConventionTest": {
                "expectedTests": 90,
                "markerEnvironment": OUTER_TIMEOUT_MARKER_ENV,
                "markerMode": "0600",
                "markerPath": OUTER_TIMEOUT_MARKER_PATH,
                "maxParallelForks": 5,
