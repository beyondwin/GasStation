...
6. `app/src/main/java/com/gasstation/MainActivity.kt`
7. `app/src/main/java/com/gasstation/navigation/GasStationNavHost.kt`
8. `feature/station-list/src/main/kotlin/com/gasstation/feature/stationlist/StationListRoute.kt`
9. `feature/station-list/src/main/kotlin/com/gasstation/feature/stationlist/StationListViewModel.kt`
10. `domain/station/src/main/kotlin/com/gasstation/domain/station/StationRepository.kt`
11. `data/station/src/main/kotlin/com/gasstation/data/station/DefaultStationRepository.kt`
12. 필요하면 `core/database`, `core/network`, `core/location`
...
- 현재 UI는 `core:designsystem`의 `LegacyTopBar`, `LegacyListRow`, `LegacyChromeCard` 같은 컴포넌트를 적극 사용한다.
