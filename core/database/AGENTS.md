...
- entity, column, index, table 변경에는 명시적인 Room schema version 결정, exported schema 검토, migration coverage가 필요하다.
...
- database 변경에는 `./gradlew :core:database:testDebugUnitTest`를 실행한다.
